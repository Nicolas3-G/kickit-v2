const initialReducerState = {
    ...
    users: new Map ([
        [1, { id: 1, name: "User 1", thumbnail: "/creationImages/flower.jpg"}], 
        [2, { id: 2, name: "User 2", thumbnail: "/creationImages/plate.jpg"}],
        [3, { id: 3, name: "User 3", thumbnail: "/creationImages/3d.jpg"}],
    ]),
    userId: 4320,
